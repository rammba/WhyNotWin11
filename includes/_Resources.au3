...
Func CopyLangFiles()
	...
	FileInstall(".\langs\080C.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\080C.lang", $FC_OVERWRITE)
	...
	FileInstall(".\langs\0C0C.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\0C0C.lang", $FC_OVERWRITE)
	FileInstall(".\langs\100A.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\100A.lang", $FC_OVERWRITE)
	FileInstall(".\langs\100C.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\100C.lang", $FC_OVERWRITE)
	FileInstall(".\langs\140A.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\140A.lang", $FC_OVERWRITE)
	FileInstall(".\langs\140C.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\140C.lang", $FC_OVERWRITE)
	...
	FileInstall(".\langs\180C.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\180C.lang", $FC_OVERWRITE)
	...
	FileInstall(".\langs\241A.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\241A.lang", $FC_OVERWRITE)
	FileInstall(".\langs\280A.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\280A.lang", $FC_OVERWRITE)
	FileInstall(".\langs\281A.lang", @LocalAppDataDir & "\WhyNotWin11\Langs\281A.lang", $FC_OVERWRITE)
